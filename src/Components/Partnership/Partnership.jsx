                        ...
                        <div className="row row-cols-lg-2 row-cols-1 align-items-center px-5 position-relative z-2">
                            ...
                            <div className="col">
                                <div className="d-flex flex-column ps-lg-3 ps-0">
                                    <p>
                                        We've empowered innovative brands to scale smarter, secure their digital future, and dominate online visibility — turning technology into measurable success.
                                    </p>
                                </div>
                            </div>
                        </div>
