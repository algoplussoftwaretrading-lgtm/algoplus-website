        ...
        const updateLogos = () => {
            ...
            if (lightMode) {
                ...
                siteLogos.forEach((logo) => {
                    logo.setAttribute('src', '/assets/images/marko-logo-dark.webp');
                });
    
                partnerLogos.forEach((img) => {
                    const src = img.getAttribute('src');
                    if (!src.includes('-dark')) {
                        img.setAttribute('src', src.replace('.webp', '-dark.webp'));
                    }
                });
            } else {
                ...
                siteLogos.forEach((logo) => {
                    logo.setAttribute('src', '/assets/images/marko-logo.webp');
                });
    
                partnerLogos.forEach((img) => {
                    const src = img.getAttribute('src');
                    img.setAttribute('src', src.replace('-dark.webp', '.webp'));
                });
            }
        };
